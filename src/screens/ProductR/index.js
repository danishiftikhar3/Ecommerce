            ...
            <View>
                <View style={styles.mainview}>
                    ...
                    <View style={styles.view2}>
                        ...
                        <Text style={styles.txt1}>Products Reviews</Text>
                    </View>
                    <View style={{ alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.props.navigation.navigate('s8'); }} style={{ alignSelf: 'center', justifyContent: 'center' }}>
                ...
                <View style={styles.v01}>
                    <View style={styles.v02}>
                        <Text style={styles.t01}>Product Reviews</Text>
                    </View>
                    <View>
                        <View style={styles.v03}>
                            ...
                            <Text style={styles.t02}>Rating</Text>
                            <Text style={styles.t02}>Comment</Text>
                            ...
                            renderItem={({ item, index }) => (
                                <View >
                                    <View style={styles.v04}>
                                        ...
                                        <View style={{ resizeMode: 'contain', alignSelf: 'center' }}>
                                            <StarRating
                                                disabled={false}
                                                maxStars={5}
