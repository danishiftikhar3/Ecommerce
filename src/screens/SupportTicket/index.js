                    ...
                    <View style={styles.v01}>
                        <View style={styles.v05}>
                            ...
                            <View style={styles.v52}>
                                ...
                                <Text style={{ fontSize: 12, paddingTop: 10 }}>Create A Ticket</Text>
                        ...
                        <View>
                            <View style={styles.v03}>
                                <View style={{ width: '20%' }}>
                                    <Text style={styles.t02}>Ticket ID</Text>
                                </View>
                                <View style={{ width: '20%' }}>

                                    <Text style={styles.t02}>Sending Docs</Text>

                                </View>
                                <View style={{ width: '20%' }}>

                                    <Text style={styles.t02}>Subject</Text>
