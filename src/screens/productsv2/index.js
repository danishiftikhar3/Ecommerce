            ...
            <ScrollView>
                <View>
                    ...
                    <View style={styles.general2}>
                        ...
                        <View style={{ borderWidth: 0.5, marginTop: 5, borderColor: '#757575', width: "85%", marginLeft: 20, opacity: 0.3 }}></View>
                        <TextInput style={{ marginTop: 5, marginLeft: 20, fontSize: 14, color: '#757575', height: 35, paddingTop: 10 }} placeholder="Brand Name"></TextInput>
                        <View style={{ borderWidth: 0.5, marginTop: 5, borderColor: '#757575', width: "85%", marginLeft: 20, opacity: 0.3 }}></View>
                        <TextInput style={{ marginTop: 5, marginLeft: 20, fontSize: 14, color: '#757575', height: 35, paddingTop: 10 }} placeholder="Product Unit"></TextInput>
                        <View style={{ borderWidth: 0.5, marginTop: 5, borderColor: '#757575', width: "85%", marginLeft: 20, opacity: 0.3 }}></View>
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={{ marginTop: 8, marginLeft: 20, fontSize: 16, color: '#757575', paddingTop: 10 }}>Barcode</Text>
                            <TextInput style={{ borderWidth: 1, width: '25%', height: 35, marginTop: 10, marginLeft: 25, fontSize: 14, borderRadius: 15 }}></TextInput>
                        </View>
                        <View style={{ borderWidth: 0.5, marginTop: 5, borderColor: '#757575', width: "85%", marginLeft: 20, opacity: 0.3 }}></View>
                    </View>
                    ...
                    <View style={styles.general}>
                        <Text style={{ marginTop: 20, marginLeft: 25, fontSize: 17, color: '#757575', fontWeight: 'bold' }}>Customer Choice</Text>
                    </View>
                    <View style={styles.general5}>

                        <View style={{ flexDirection: "row", width: "93%", marginTop: 5 }}>
                            <Text style={{ marginTop: 10, marginLeft: 25, fontSize: 16, color: '#757575', }}>Unit Price</Text>
                            <Image style={styles.e1} source={require('../../assets/e1.png')}></Image>
                            <Image style={styles.e1} source={require('../../assets/e2.png')}></Image>
                            <Image style={styles.e1} source={require('../../assets/e3.png')}></Image>
                            <Image style={styles.e1} source={require('../../assets/e4.png')}></Image>
                            <TouchableOpacity>
                                <Image style={styles.bin} source={require('../../assets/mbin.png')}></Image>
                            </TouchableOpacity>
                                ...
                                <View >
                                    <View >
                                        <Picker
                                            ...
                                            style={{ height: 20, width: 90, marginBottom: 30, }}
                        ...
                        <View style={{ flexDirection: "row", width: "100%", marginTop: 10 }}>
                            <Text style={{ marginTop: 10, marginLeft: 25, fontSize: 16, color: '#757575', }}>Size</Text>
                            <TextInput placeholder='S' style={{ borderWidth: 1, borderColor: '#757575', width: '10%', height: 35, borderRadius: 2, marginTop: 3, marginLeft: 10, paddingLeft: 9 }}></TextInput>
                            <TextInput placeholder='M' style={{ borderWidth: 1, borderColor: '#757575', width: '10%', height: 35, borderRadius: 2, marginTop: 3, marginLeft: 10, paddingLeft: 9 }}></TextInput>
                            <TextInput placeholder='L' style={{ borderWidth: 1, borderColor: '#757575', width: '10%', height: 35, borderRadius: 2, marginTop: 3, marginLeft: 10, paddingLeft: 9 }}></TextInput>
                            <TextInput placeholder='XL' style={{ borderWidth: 1, borderColor: '#757575', width: '10%', height: 35, borderRadius: 2, marginTop: 3, marginLeft: 10, paddingLeft: 7 }}></TextInput>
                            <TouchableOpacity>
                                <Image style={styles.bin2} source={require('../../assets/mbin.png')}></Image>
                            </TouchableOpacity>
                        ...
                        <View style={{ borderWidth: 0.5, marginTop: 15, borderColor: '#757575', width: "85%", marginLeft: 20, opacity: 0.3 }}></View>
                        <View style={{ flexDirection: "row", width: "93%", justifyContent: "space-between", marginTop: 10 }}>
                            <Text style={{ marginTop: 10, marginLeft: 25, fontSize: 16, color: '#757575', }}>Fabric</Text>
                            <TextInput style={{ borderWidth: 1, borderColor: '#757575', width: '25%', height: 35, borderRadius: 2, marginTop: 3, paddingLeft: 8, }}></TextInput>
                            <View>
                                <View >
                                    <Picker
                                        selectedValue={selectedValue}
                                        style={{ height: 30, width: 120, marginTop: 5 }}
                                        onValueChange={(itemValue, itemIndex) => setSelectedValue(itemValue)}
                                    >
                                        <Picker.Item label="Cotton" value="java" />
                                        <Picker.Item label="Polister" value="js" />
                                    </Picker>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={styles.general5}>
                        ...
                        <View style={{ borderWidth: 0.5, marginTop: 10, borderColor: '#757575', width: "85%", marginLeft: 20, opacity: 0.3 }}></View>
                        <View style={{ flexDirection: "row", width: "93%", justifyContent: "space-between", marginTop: 10 }}>
                            <Text style={{ marginTop: 10, marginLeft: 25, fontSize: 16, color: '#757575', }}>Quantitiy</Text>
                            <TextInput style={{ borderWidth: 1, borderColor: '#757575', width: '45%', height: 35, borderRadius: 20, marginTop: 3 }}></TextInput>
                        </View>
                    ...
                    <View style={styles.general}>
                        <Text style={{ marginTop: 20, marginLeft: 25, fontSize: 17, color: '#757575', fontWeight: 'bold' }}>Shipping</Text>
                    </View>
                    <View style={styles.general3}>

                        <View style={{ flexDirection: "row", width: "93%", justifyContent: "space-between", marginTop: 10 }}>
                            <Text style={{ marginTop: 10, marginLeft: 25, fontSize: 16, color: '#757575', }}>Flat Rate        </Text>
                            <TextInput style={{ borderWidth: 1, borderColor: '#757575', width: '25%', height: 35, borderRadius: 20, marginTop: 3, }}></TextInput>
                            <ToggleSwitch
                        ...
                        <View style={{ borderWidth: 0.5, marginTop: 10, borderColor: '#757575', width: "85%", marginLeft: 20, opacity: 0.3 }}></View>
                        <View style={{ flexDirection: "row", width: "93%", justifyContent: "space-between", marginTop: 10 }}>
                            <Text style={{ marginTop: 10, marginLeft: 25, fontSize: 16, color: '#757575', }}>Free Shipping</Text>
                            <TextInput style={{ borderWidth: 1, borderColor: '#757575', width: '25%', height: 35, borderRadius: 20, marginTop: 3 }}></TextInput>
                            <ToggleSwitch
                    ...
                    <View style={styles.general6}>
                        <View >
                            <TextInput style={{ borderWidth: 0.5, marginTop: 25, borderColor: '#757575', width: "85%", marginLeft: 20, height: 140 }}>
